...
export const DEFAULT_META: PageMeta = {
  title: 'Jedals',
  description:
    'The most popular AMM on BSC by user count! Earn JEDALS through yield farming or win it in the Lottery, then stake it in Syrup Pools to earn more tokens!',
  image: 'https://i.imgur.com/h0Tq6xi.png',
}
